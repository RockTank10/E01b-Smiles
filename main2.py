...
arcade.draw_ellipse_filled(face_x + -50, face_y + 25, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + 50, face_y + 25, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x + -48, face_y + 30, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + 52, face_y + 30, 3, open_color.gray_2)
